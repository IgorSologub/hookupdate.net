...
public class MainTest extends BaseTest {
    ...
    @Test(invocationCount = 2, successPercentage = 99)
    public void seeMoreRegButtonTest () {
        basePage.closePopup();
        mainPage.seeMoreRegButtonClick();
        basePage.nextTab();
        basePage.waitThirtySeconds();
        assertTrue(basePage.checkTitles(REG_TITLES));
        basePage.closeTabAndMoveToNext();
    ...
    @Test(invocationCount = 2, successPercentage = 99)
    public void hookupSliderTest () {
        basePage.closePopup();
        mainPage.scrollToHookupSlider();
        mainPage.nextHookupSliderButtonClick();
        basePage.waitOneSeconds();
        assertTrue(mainPage.hookupSliderVisibleCheck());
    }
